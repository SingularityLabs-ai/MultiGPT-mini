...
function useTranslation(ns) {
  ...
  if (!i18n) {
    ...
    var notReadyT = function notReadyT(k, optsOrDefaultValue) {
      ...
      if (optsOrDefaultValue && (0, _typeof2["default"])(optsOrDefaultValue) === 'object' && typeof optsOrDefaultValue.defaultValue === 'string') return optsOrDefaultValue.defaultValue;
  ...
  (0, _react.useEffect)(function () {
    ...
    if (!ready && !useSuspense) {
      if (props.lng) {
        (0, _utils.loadLanguages)(i18n, props.lng, namespaces, function () {
