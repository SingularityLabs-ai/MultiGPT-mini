...
declare type ClickFrameData = BaseDomFrameData;
...
export declare type SpanFrame = BaseSpanFrame | HistoryFrame | RequestFrame | LargestContentfulPaintFrame | MemoryFrame | NavigationFrame | PaintFrame | ResourceFrame;
export declare type ReplayFrame = BreadcrumbFrame | SpanFrame;
...
export declare type ReplayFrameEvent = BreadcrumbFrameEvent | SpanFrameEvent | OptionFrameEvent;
export {};
