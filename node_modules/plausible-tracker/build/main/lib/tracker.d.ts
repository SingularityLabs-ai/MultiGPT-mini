 ...
 */
export declare type PlausibleEventData = {
    /**
 ...
 */
export declare type PlausibleOptions = PlausibleInitOptions & PlausibleEventData;
/**
 ...
 * ```
 */
declare type EnableAutoOutboundTracking = (targetNode?: Node & ParentNode, observerInit?: MutationObserverInit) => Cleanup;
/**
